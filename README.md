...
This module is used to configure the SNMPD agent on linux using snmp v3. By default it 
will allow only authenticated and encrypted access to snmp data.
...
**FIXME:** Ensure the *Beginning with simp_snmp* section is correct and complete, then remove this message!
