...
class simp_snmpd (
  ...
  String                         $contact                   = "root@${facts['networking']['fqdn']}",
  Integer                        $services                  = 72,
  String                         $sysname                   = $facts['networking']['fqdn'],
  String                         $rsync_source              = "snmp_${environment}_${facts['os']['name']}",
  Boolean                        $rsync_dlmod               = false,
  Boolean                        $rsync_mibs                = false,
  StdLib::AbsolutePath           $rsync_dlmod_dir           = '/usr/lib64/snmp',
  StdLib::AbsolutePath           $rsync_mibs_dir            = '/usr/share/snmp',
